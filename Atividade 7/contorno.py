...
plt.figure(figsize=(12, 12))  # Ajuste os valores conforme necessário
...
# Mostrar a última imagem em tamanho maior
plt.figure(figsize=(10, 10))  # Tamanho maior apenas para a última imagem
